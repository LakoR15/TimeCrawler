...
public class Message {
    ...
    public void sendMessage(final String user, final String text) throws JsonProcessingException {
        ...
        final Thread thread = new Thread(new Runnable() {
            public void run() {
                ...
                String result = null;
                try {
                    result = restTemplate.postForObject(uri,new MessageTemplate().getUserTemplate(user, text), String.class);
